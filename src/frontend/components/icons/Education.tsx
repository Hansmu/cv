...
export const Education: React.FC<SvgProps> = ({ className }) => {
  // <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools. Author: https://www.svgrepo.com/author/Esri/ -->
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
